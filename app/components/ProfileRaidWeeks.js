        ...
        if(user_availability) {
          ...
          user_availabilityRow = (
            <tr key={raidweek.id}>
              ...
              <td className='col-xs-3'><textarea maxLength="255" style={{'min-height': 200 + 'px'}} value={user_availability.user_note} onChange={e => ProfileRaidWeeksActions.updateUserAvailabilityNote(user_availability.id, e.target.value)} /></td>
