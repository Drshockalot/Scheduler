...
router.get('/blizzard', function(req, res, next) {
  https.get('https://eu.api.battle.net/wow/user/characters?locale=en_GB&apikey=8fc24vcgky6r8yzja8a4efxncgu8z77g&access_token=' + req.session.passport.user.token, function(res) {
